...
## ⚠️ О ложных срабатываниях антивирусов (сейчас может такого и не быть из-за Nuitka)
...
Также некоторые антивирусы могут детектировать Nuitka-сборку как подозрительную 
ESET: Packed.Nuitka.AL — прямо указывает что это детект упаковщика, а не вируса
Microsoft: Wacatac.B!ml — автоматический ML-детект, снимается после ручной проверки
AI-детекты (Malware.AI и подобные) — нейросети ошибаются на редких упаковщиках
