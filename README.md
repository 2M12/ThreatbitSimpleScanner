...
Некоторые антивирусы (особенно песочницы с правилами Sigma) могут ложно детектировать `ThreatbitScanner.exe` как «потенциально опасный», ссылаясь на распаковку `vcruntime140.dll`. Это связано с тем, что программа собрана с помощью PyInstaller (`--onefile`), который упаковывает необходимые библиотеки вместе с исполняемым файлом.
...
SHA-256: a7bd7ca4ba0f21d7f1b45077b1b4c55d76ee031ae2b0de749b93899d30a2481f
```
